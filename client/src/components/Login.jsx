...
//     e.preventDefault();
//     try {
//       let data; // Declare data once for the entire block
...
//       if (data.data.success) { // Use data.data because Axios wraps the response
...
//           Welcome back! Please <span>{state}</span> to continue.
//         </p>
